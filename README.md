...
[![HTML Manuscript](https://img.shields.io/badge/manuscript-HTML-blue.svg)](https://dhimmel.github.io/psb-manuscript/)
[![PDF Manuscript](https://img.shields.io/badge/manuscript-PDF-blue.svg)](https://dhimmel.github.io/psb-manuscript/manuscript.pdf)
...
Please open [an issue](https://github.com/dhimmel/psb-manuscript/issues) for questions related to Manubot usage, bug reports, or general inquiries.
...
When a commit to the `master` branch occurs (for example, when a pull request is merged), Travis CI builds the manuscript and writes the results to the [`gh-pages`](https://github.com/dhimmel/psb-manuscript/tree/gh-pages) and [`output`](https://github.com/dhimmel/psb-manuscript/tree/output) branches.
...
Please open [an issue](https://github.com/dhimmel/psb-manuscript/issues) for any question related to licensing.
